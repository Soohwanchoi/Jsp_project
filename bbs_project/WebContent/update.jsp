...
<body>
	...
	<!-- 헤더 -->
	<jsp:include page="/common/update_header.jsp" flush="false" />
		...
		<form method="POST" action="updateAction.jsp?bbsID=<%= bbsID %>">
			<table class="table table-striped" style="text-align:center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<td>
							<textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2000" style="height:350px;"><%= bbsVO.getBbsContent() %></textarea>
						</td>
					</tr>
				</tbody>
			</table>
			<input type="button" value="뒤로가기" onclick="history.back(-1);" class="btn btn-success btn-arraw-left">
